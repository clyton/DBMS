...
void FileHandle::updateFileStat(FILE *pageFile, FileStat &fileStat)
{
...
RC PagedFileManager::closeFile(FileHandle &fileHandle)
{
  ...
  fileHandle.updateFileStat(file, currentFileStats);
...
void FileHandle::writeFileStatsToDisk()
{
  FILE *file = getFile();
  // persist the updated page values and pointers before closing file
  // get the current file stats
